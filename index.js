...
const config = {
  ...
  mapStyle: 'mapbox://styles/dnsalazar10/clrrwfra300j501p57jb57udx',
...
/**Chart Title */
  ...
  /*** The name of the data field to pull the place name from for chart labeling */
  placeNameField: 'name',
  ...
  dataSeriesLabel: 'Population Growth',
